...
st.title("Geographical Entity Recognition App 🌍")
...
if st.session_state.nlp:
    text_input = st.text_area("Enter text to analyze:", "Ashkāsham belongs to the state of Badakhshan, in the country of Afghanistan.")
